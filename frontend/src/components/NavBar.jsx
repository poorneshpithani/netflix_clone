    ...
    <header className='max-w-6xl mx-auto flex flex-wrap items-center justify-between p-4 h-20'>
      <div className='flex items-center gap-10 z-50'>
        ...
        <div className='hidden sm:flex gap-2 items-center'>
            <Link to={'/'} className='hover:underline' onClick={()=> setContentType("movie")}>Moives</Link>
      ...
      <div className='flex gap-2 items-center z-50'>
        ...
        <img src={user.image} alt="avator" className='h-8 rounded cursor-pointer' />
      ...
      {/* mobile navbar items */}
        ...
        {isMobileMenuOpen && (
            <div className='w-full sm:hidden mt-4 z-50 bg-black border rounded border-gray-800'>
                <Link to={'/'} className='block hover:underline p-2' onClick={toggleMobileMenu}>Moives</Link>
